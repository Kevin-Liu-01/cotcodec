# H100 publication-lane upgrade research — 2026-09-01

Source: frontier sweep cell `infra-slurm` (independent research cell; primary URLs inline). Commands marked (V) come from the cited official docs; (U) are assembled and **not verified in official docs**. Nothing here has been executed on `fal-h100-01`.
