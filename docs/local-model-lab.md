...
| `cotcodec-research:0b3ecef0-architecture` (built 2026-09-01 by Slurm job 357 from commit `0b3ecef0`) | image ID `sha256:3804466639c13f132be4b0369de4d3395b9d5ea2d3dc100cd38884c75197fe29`; repo digest `127.0.0.1:5000/cotcodec-research@sha256:02965f3d696d4e516a7cd6d5c03434e9098139738748ae778ed967215db7be6d` | as `999f5583` plus **tilelang 0.1.13** — required because fla 0.5.2 guards the gated GDN backward on Hopper under Triton < 3.7.1 (fla #640). **This is the pilot image.** Measured eager throughput inside it: 282k tok/s (134M hybrid), 73k tok/s (422M) — `research/evidence/infrastructure/fla-throughput-h100-2026-09-01.json` |
