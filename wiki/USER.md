...
> Read this file on every session. It defines who Kevin is in this project.
...
- **Harness-minded** — thinks in terms of eval harnesses, not prompts.
  Built claude-code harness with hooks, rules, skills, and quality gates.
- **Design taste** — can make visualizations and paper figures that communicate
  clearly (Pareto frontiers, decomposition charts, routing decision trees)

## Communication Preferences

- Concise over comprehensive
- Tables over prose for comparisons
- Direct recommendations over option menus
- "Do it" means execute without further questions
- Show the data first, explain the method second
